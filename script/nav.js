...
document
  .querySelector(".nav .buttons .toggleLayout")
...
document
  .querySelector(".nav .buttons .clear")
  .addEventListener("click", (e) => {
...
document
  .querySelector(".nav .buttons .screenshot")
  .addEventListener("click", (e) => {
    ...
    var sourceHeight =
      src.height(); /*clientHeight/offsetHeight from div#target*/
    try {
